...
bool Frontend::Parse(std::string &InputFile, clang::ASTConsumer *R) {
  ...
  HeaderSearchOpts.AddPath("/postgresql-12.14/src/include", clang::frontend::Angled, false, false);
  HeaderSearchOpts.AddPath("/postgresql-12.14/src/common", clang::frontend::Angled, false, false);
